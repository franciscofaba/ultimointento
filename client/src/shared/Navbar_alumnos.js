...
function Navbar_shared() {
    ...
    const InformacionCursos = async () => {
        
        navigate(`/informacioncursos/${idUser}`);
    };
    ...
    return (
        <>
            <Navbar className="navbar-custom">
                ...
                <Navbar.Brand className="texto" href="#home" >{t("nav.t1")}</Navbar.Brand>
                <Nav className="me-auto">
                    <Nav.Link className="texto" onClick={() => { navigate(`/portal/${idUser}`) }}>{t("nav.t3")}</Nav.Link>
                    <Nav.Link className="texto" onClick={() => gotoAttendance()}  >{t("nav.t4")}</Nav.Link>
                    <Nav.Link className="texto" onClick={() => InformacionCursos()}  >Consultar cursos</Nav.Link>
